...
public interface Guild extends ISnowflake
{
     ...
     *     <li>COMMUNITY - Guild can enable welcome screen, Membership Screening, and discovery, and receives community updates</li>
     *     <li>DISCOVERABLE - Guild shows up in discovery tab</li>
     *     <li>FEATURABLE - Guild shows up in featured section of discovery tab</li>
     *     <li>INVITE_SPLASH - Guild has custom invite splash. See {@link #getSplashId()} and {@link #getSplashUrl()}</li>
     *     <li>MEMBER_VERIFICATION_GATE_ENABLED - Guild has enabled Member Screening</li>
     *     <li>NEWS - Guild can create news channels</li>
     *     <li>PARTNERED - Guild is "partnered"</li>
     *     <li>PREVIEW_ENABLED - Guild has enabled Guild preview</li>
     ...
     *     <li>WELCOME_SCREEN_ENABLED - Guild has welcome screen enabled</li>
     * </ul>
     *
